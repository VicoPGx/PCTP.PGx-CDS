...
namespace FileHelpers.Tests.CommonTests
{
    ...
    public class DiffRecords
    {
        ...
        public void DiffCustomers()
        {
            ...
            CustomersVerticalBar[] res = engine.OnlyNewRecords(FileTest.Good.CustomersVerticalBarOlds.Path,
                FileTest.Good.CustomersVerticalBar.Path);
        ...
        public void DiffCustomersAllEquals()
        {
            var engine = new FileDiffEngine<CustomersVerticalBar>();
            CustomersVerticalBar[] res = engine.OnlyNewRecords(FileTest.Good.CustomersVerticalBarOlds.Path,
                FileTest.Good.CustomersVerticalBarOlds.Path);
        ...
        {
            var engine = new FileDiffEngine<CustomersVerticalBar>();
            CustomersVerticalBar[] res = engine.OnlyNewRecords(FileTest.Good.EmptyFile.Path,
                FileTest.Good.CustomersVerticalBarOlds.Path);
        ...
        public void OnlyNewRecords()
        {
            ...
            DiffOrdersFixed[] res = engine.OnlyNewRecords(FileTest.Good.DiffOrdersOld.Path,
                FileTest.Good.DiffOrdersNew.Path);
        ...
        {
            var engine = new FileDiffEngine<DiffOrdersFixed>();
            DiffOrdersFixed[] res = engine.OnlyMissingRecords(FileTest.Good.DiffOrdersOld.Path,
                FileTest.Good.DiffOrdersNew.Path);
        ...
        {
            var engine = new FileDiffEngine<DiffOrdersFixed>();
            DiffOrdersFixed[] res = engine.OnlyNoDuplicatedRecords(FileTest.Good.DiffOrdersOld.Path,
                FileTest.Good.DiffOrdersNew.Path);
        ...
        {
            var engine = new FileDiffEngine<DiffOrdersFixed>();
            DiffOrdersFixed[] res = engine.OnlyDuplicatedRecords(FileTest.Good.DiffOrdersOld.Path,
                FileTest.Good.DiffOrdersNew.Path);
            Assert.AreEqual(10, res.Length);
        }
