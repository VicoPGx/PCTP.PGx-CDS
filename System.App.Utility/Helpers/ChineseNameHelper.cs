...
namespace System.App.Utility.Helpers
{
    ...
    public static class ChineseNameHelper
    {
        ...
        public static void Parse(string fullName, out string lastName, out string firstName)
        {
            ...
            // case: last name matched
            foreach (var x in LastNames.Reverse()) // first consider last names with double characters
            {
                if (fullName.StartsWith(x))
                {
                    lastName = x;
                    firstName = fullName.Replace(x, string.Empty);
                    return;
                }
            }

            // case: last name not matched
            lastName = string.Empty;
            firstName = fullName;
        }
    }
