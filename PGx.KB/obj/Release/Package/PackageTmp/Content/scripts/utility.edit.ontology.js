...
function addTerm(term) {
    ...
    if (area) {
        ...
        newDiv.innerHTML = '<input style="margin:3px; width: 220px;" value = "' + term + '"/><img onclick="deleteTerm(this);" style="cursor:pointer; position: relative; margin-bottom: -5px" src="/Content/images/trash.png" alt="' + '@Resource.Delete' + '" />';
